...
export default function ProblemSection({ onAction }) {
  return (
    <section id="problem" className="py-16 sm:py-24 relative overflow-hidden scroll-mt-24" style={{ backgroundColor: 'var(--bg-deep)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12">
        ...
        {/* ════════════════════════════════════════════
            MOBILE LAYOUT: Simple stacked cards (no laptop frame)
            Visible on screens < 768px
            ════════════════════════════════════════════ */}
        <div className="block md:hidden space-y-4">

          {/* Card 1: The Manual Way */}
          <div className="rounded-2xl p-5 space-y-4 relative overflow-hidden" style={{ border: '1px solid rgba(239, 68, 68, 0.3)', backgroundColor: 'rgba(239, 68, 68, 0.06)' }}>
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-white leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
                    The Manual Way
                  </h3>
                  <span className="text-[10px] text-red-400 font-semibold">Owner Pulls Every String</span>
                </div>
              </div>
              <span className="text-[9px] font-mono font-bold bg-red-500/10 text-red-300 px-2.5 py-1 rounded-full border border-red-500/20 shrink-0 whitespace-nowrap">
                18 hrs/week
              </span>
            </div>
          ...
          <div className="flex justify-center">
            <div className="w-10 h-10 rounded-full bg-[#24150A] border-2 border-amber-500/40 shadow-xl flex items-center justify-center text-[#F7CE55] font-mono text-sm font-bold">
              VS
            </div>
          </div>

          {/* Card 2: The Puppetify Way */}
          <div className="rounded-2xl p-5 space-y-4 relative overflow-hidden" style={{ border: '1px solid rgba(247, 206, 85, 0.4)', backgroundColor: 'rgba(247, 206, 85, 0.06)', boxShadow: '0 0 40px rgba(247, 206, 85, 0.08)' }}>
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-amber-500/10 border border-amber-500/30 text-[#F7CE55] flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-[#F7CE55] font-semibold">Strings Pull Themselves 24/7</span>
                </div>
              </div>
              <span className="text-[9px] font-mono font-bold bg-amber-500/10 text-[#F7CE55] px-2.5 py-1 rounded-full border border-amber-500/30 shrink-0 whitespace-nowrap">
                0 hrs manual
              </span>
            </div>
        ...
        {/* ════════════════════════════════════════════
            DESKTOP LAYOUT: MacBook Laptop Screen Mockup
            Visible on screens >= 768px
            ════════════════════════════════════════════ */}
        <div className="hidden md:block max-w-5xl mx-auto relative pt-2 pb-6">
          
          {/* MacBook Outer Display Bezel */}
          <div 
            className="relative rounded-t-[32px] bg-[#0E0E10] border-[10px] border-[#1C1D21] p-3"
            style={{
              boxShadow: '0 30px 70px -12px rgba(0, 0, 0, 0.9), inset 0 0 0 1px rgba(255, 255, 255, 0.08)',
            }}
          >
            {/* Top Camera Notch */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-36 h-[18px] bg-[#1C1D21] rounded-b-xl flex items-center justify-center gap-2 z-30">
              <div className="w-2 h-2 rounded-full bg-[#090A0C] border border-[#2A2B30]" />
              <div className="w-1.5 h-1.5 rounded-full bg-[#152438]" />
            </div>
            ...
            <div className="bg-[#120A04] p-8 rounded-b-xl border-t border-white/5 relative">
              ...
              <div className="grid grid-cols-2 gap-6 relative">
                ...
                {/* Card 1: The Manual Way */}
                <div className="glass-card rounded-2xl p-7 space-y-5 relative overflow-hidden" style={{ border: '1px solid rgba(239, 68, 68, 0.3)', backgroundColor: 'rgba(239, 68, 68, 0.04)' }}>
                ...
                <div className="glass-card rounded-2xl p-7 space-y-5 relative overflow-hidden" style={{ border: '1px solid rgba(247, 206, 85, 0.4)', backgroundColor: 'rgba(247, 206, 85, 0.05)', boxShadow: '0 0 30px rgba(247, 206, 85, 0.08)' }}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
              ...
              <div className="mt-8 flex justify-center w-full">
                <div className="max-w-[98%] overflow-x-auto rounded-2xl bg-black/40 backdrop-blur-xl border border-white/20 p-2 shadow-2xl flex items-center justify-center">
                  <img 
          ...
          <div 
            className="h-5 bg-gradient-to-r from-[#707275] via-[#C8C9CC] to-[#707275] rounded-b-2xl shadow-2xl relative flex justify-center border-t border-[#8E9093]"
          >
            {/* Thumb Groove Notch */}
            <div className="w-28 h-2 bg-[#4A4B4E] rounded-b-md" />
          </div>
