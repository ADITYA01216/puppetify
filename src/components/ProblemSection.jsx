    ...
    <section id="problem" className="py-24 relative overflow-hidden scroll-mt-24" style={{ backgroundColor: 'var(--bg-deep)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12">
        ...
        <div className="max-w-5xl mx-auto relative pt-2 pb-6">
          ...
          <div 
            className="relative rounded-t-[24px] sm:rounded-t-[32px] bg-[#0E0E10] border-[6px] sm:border-[10px] border-[#1C1D21] pt-5 sm:pt-6 pb-2 px-1.5 sm:px-3"
            style={{
              boxShadow: '0 30px 70px -12px rgba(0, 0, 0, 0.9), inset 0 0 0 1px rgba(255, 255, 255, 0.08)',
            }}
          >
            {/* Top Camera Notch */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 sm:w-32 h-2.5 sm:h-3.5 bg-[#1C1D21] rounded-b-lg flex items-center justify-center gap-1.5 z-30">
              <div className="w-1.5 h-1.5 rounded-full bg-[#090A0C] border border-[#2A2B30]" />
              <div className="w-1 h-1 rounded-full bg-[#152438]" />
            </div>
            ...
            <div className="bg-[#181512] rounded-t-xl px-2.5 sm:px-4 py-2 border-b border-white/10 flex items-center justify-between text-xs text-white/70 select-none z-20">
              ...
              {/* URL Address Bar */}
              <div className="flex items-center gap-1.5 bg-[#2B231D] px-2.5 sm:px-4 py-1 rounded-md text-[10px] sm:text-[11px] text-white/80 font-mono border border-white/10 shrink-0">
              ...
              <div className="hidden sm:flex items-center gap-3 text-[10px] font-mono text-white/50 shrink-0">
            ...
            <div className="bg-[#120A04] p-3.5 sm:p-8 rounded-b-xl border-t border-white/5 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                ...
                <div className="glass-card rounded-2xl p-4 sm:p-7 space-y-4 sm:space-y-5 relative overflow-hidden" style={{ border: '1px solid rgba(239, 68, 68, 0.3)', backgroundColor: 'rgba(239, 68, 68, 0.04)' }}>
                  <div className="flex flex-wrap sm:flex-nowrap items-start justify-between gap-2">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 flex items-center justify-center font-bold shrink-0">
                        <XCircle className="w-4 h-4 sm:w-5 sm:h-5" />
                      </div>
                      <div>
                        <h3 className="text-base sm:text-lg font-bold text-white leading-tight" style={{ fontFamily: 'var(--font-display)' }}>
                          The Manual Way
                        </h3>
                        <span className="text-[10px] sm:text-[11px] text-red-400 font-semibold block mt-0.5">Owner Pulls Every String</span>
                      </div>
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-mono font-bold bg-red-500/10 text-red-300 px-2 sm:px-2.5 py-1 rounded-full border border-red-500/20 shrink-0">
                      18 hrs/week lost
                    </span>
                  </div>
                  ...
                  <div className="pt-3 border-t border-red-500/20 text-[10px] sm:text-[11px] text-red-400 font-semibold flex items-center justify-between gap-2">
                    <span>Result: Burnout & missed revenue</span>
                    <span className="font-mono shrink-0">High Stress</span>
                  </div>
                </div>

                {/* Card 2: The Puppetify Autopilot Way */}
                <div className="glass-card rounded-2xl p-4 sm:p-7 space-y-4 sm:space-y-5 relative overflow-hidden" style={{ border: '1px solid rgba(247, 206, 85, 0.4)', backgroundColor: 'rgba(247, 206, 85, 0.05)', boxShadow: '0 0 30px rgba(247, 206, 85, 0.08)' }}>
                  <div className="flex flex-wrap sm:flex-nowrap items-start justify-between gap-2">
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-amber-500/10 border border-amber-500/30 text-[#F7CE55] flex items-center justify-center font-bold shrink-0">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] sm:text-[11px] text-[#F7CE55] font-semibold block mt-0.5">Strings Pull Themselves 24/7</span>
                      </div>
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-mono font-bold bg-amber-500/10 text-[#F7CE55] px-2 sm:px-2.5 py-1 rounded-full border border-amber-500/30 shrink-0">
                      0 hrs manual work
                    </span>
                  </div>
                  ...
                  <div className="pt-3 border-t border-amber-500/20 flex items-center justify-between gap-2 text-[10px] sm:text-[11px] text-[#F7CE55] font-semibold">
                    <span>Result: Reclaim 18 hrs & double reviews</span>
                    <span className="font-mono shrink-0">100% Autopilot</span>
                  </div>
                </div>
